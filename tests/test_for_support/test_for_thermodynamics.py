...
def metabolite_registry():
    ...
    registry["h2o_c_name"] = cobra.Metabolite("h2o_c", name="Water", compartment="c")
    registry["o2_c_name"] = cobra.Metabolite("o2_c", name="Oxygen", compartment="c")
    registry["h2_c_name"] = cobra.Metabolite("h2_c", name="Hydrogen", compartment="c")
    registry["whack_c"] = cobra.Metabolite("whack_c", name="Whack", compartment="c")
...
def list_annotation():
    ...
    c = cobra.Metabolite("h2o_c", compartment="c")
    c.annotation["kegg.compound"] = ["C00001", "C01328", "D00001", "D03703", "D06322"]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(["G12322"], None, marks=pytest.mark.raises(exception=ValueError)),
    ],
)
...
@pytest.mark.parametrize(
    "reaction, expected",
    [
        ("direct_annotation", {"C00668": -1, "C00001": -1, "C00267": 1, "C00009": 1}),
        ("list_annotation", {"C00282": -2, "C00007": -1, "C00001": 1}),
        # We currently do not match names because it takes too long.
...
def test_find_incorrect_thermodynamic_reversibility(reaction, expected):
    ...
    result = tuple(map(len, thermo.find_thermodynamic_reversibility_index([reaction])))
